class DetailsModel {
  ...
  DetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new DetailsGoodsList.fromJson(json['data']) : null;
  }
...
class DetailsGoodsList {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  DetailsGoodsList({this.goodInfo, this.goodComments, this.advertesPicture});

  DetailsGoodsList.fromJson(Map<String, dynamic> json) {
...
class GoodInfo {
  ...
  GoodInfo.fromJson(Map<String, dynamic> json) {
    ...
    goodsDetail = json['goodsDetail'].cast<String>();
  }
